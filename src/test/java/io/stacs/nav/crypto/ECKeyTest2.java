...
public class ECKeyTest2 {
    private static final Logger log = LoggerFactory.getLogger(ECKeyTest2.class);

    private static final SecureRandom secureRandom = new SecureRandom();

    private String privString = "3CCE3E0071B4B4AA35E0163EE3468AD31C2F3478AD940F9609E9AA5B92648360";
...
//            assertArrayEquals(address, ECKey.signatureToAddress(rawHash, sig.toBase64()));
    ...
    public void testVerifySignature4() {
        ...
        ECDSASignature sig = ECDSASignature.fromComponents(r, s, v);
    ...
    public void testSignVerify() {
        ...
        byte[] input = HashUtil.sha3(message.getBytes());
        System.out.println("Hex.toHexString(input) = " + Hex.toHexString(input));
        ECDSASignature sig = key.sign(input);
        System.out.println("sig = " + sig.toHex());
